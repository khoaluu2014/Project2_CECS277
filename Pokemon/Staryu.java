...
/**
 * Class Staryu is a type of Pokemon and inherits variables and methods from 
 * Pokemon class. Class Staryu also implements Water interface and calls 
...
public class Staryu extends Pokemon implements Water{
  /**
   * Calls superclass Pokemon's constructor and assigns "Staryu" for name of pokemon.
   */
  public Staryu(){
    super("Staryu");
  }
  ...
  /**
   * Gives the battle description when trainer chooses BubbleBeam or when wild pokemon randomly 
   * chooses BubbleBeam for special attack, and calculates the amount of damage that wild pokemon takes,
   * as well as the damage taken on the trainer's pokemon.
   * @param p wild pokemon that trainer's pokemon is fighting with.
   * @return string summary of battle description.
   */
